      ...
      <div>
        ...
        <div className="mt-4 grid grid-cols-2 gap-3 lg:grid-cols-4">
          <div className="relative overflow-hidden rounded-2xl border border-[#E2E8F0] bg-[linear-gradient(180deg,#FFFFFF_0%,#F8FAFC_100%)] p-4 shadow-sm shadow-black/5 dark:border-[#1F2A44] dark:bg-none dark:bg-[#0B1424] dark:shadow-black/20">
            ...
            <p className="mt-2 text-2xl font-semibold tracking-tight text-[#0F172A] dark:text-[#F1F5F9]">{totalClients}</p>
            <p className="mt-1 text-xs text-[#64748B] dark:text-[#94A3B8]">Clientes registrados</p>
          </div>
          ...
          <div className="rounded-2xl border border-emerald-500/25 bg-emerald-500/10 p-4 shadow-sm shadow-black/5 dark:border-emerald-400/25 dark:bg-emerald-400/10 dark:shadow-black/20">
            <div className="flex items-center justify-between gap-3">
              <p className="text-xs font-medium text-emerald-700 dark:text-emerald-200/80">Con email</p>
            ...
            <p className="mt-2 text-2xl font-semibold tracking-tight text-emerald-800 dark:text-emerald-100">{withEmail}</p>
            <p className="mt-1 text-xs text-emerald-700/80 dark:text-emerald-200/80">{emailRate}% con email</p>
          </div>
          ...
          <div className="rounded-2xl border border-[#3B82F6]/25 bg-[#3B82F6]/10 p-4 shadow-sm shadow-black/5 dark:border-[#3B82F6]/30 dark:shadow-black/20">
            <div className="flex items-center justify-between gap-3">
              <p className="text-xs font-medium text-[#64748B] dark:text-[#94A3B8]">Con teléfono</p>
            ...
            <p className="mt-2 text-2xl font-semibold tracking-tight text-[#0F172A] dark:text-[#F1F5F9]">{withPhone}</p>
            <p className="mt-1 text-xs text-[#64748B] dark:text-[#94A3B8]">Contactables</p>
          </div>

          <div className="relative overflow-hidden rounded-2xl border border-[#E2E8F0] bg-[linear-gradient(180deg,#FFFFFF_0%,#F8FAFC_100%)] p-4 shadow-sm shadow-black/5 dark:border-[#1F2A44] dark:bg-none dark:bg-[#0B1424] dark:shadow-black/20">
            <div className="flex items-center justify-between gap-3">
              <p className="text-xs font-medium text-[#64748B] dark:text-[#94A3B8]">Con notas</p>
              <div className="flex h-9 w-9 items-center justify-center rounded-xl border border-[#E2E8F0] bg-[#F8FAFC] text-[#0F172A] shadow-sm dark:border-[#1F2A44] dark:bg-[#111E35] dark:text-[#F1F5F9]">
                <BriefcaseBusiness className="h-4 w-4" />
              </div>
            </div>
            <p className="mt-2 text-2xl font-semibold tracking-tight text-[#0F172A] dark:text-[#F1F5F9]">{withNotes}</p>
            <p className="mt-1 text-xs text-[#64748B] dark:text-[#94A3B8]">Información adicional</p>
          </div>
        </div>
      </div>
